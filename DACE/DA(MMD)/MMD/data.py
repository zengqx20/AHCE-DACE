...
def load_and_encode_train_data(num_queries, num_materialized_samples):
    file_name_queries = "workloads/source/subtrain-500"
    ...
    samples_train = samples_enc
    predicates_train = predicates_enc
    joins_train = joins_enc
    labels_train = label_norm
    ...
    return dicts, column_min_max_vals, min_val, max_val, labels_train, max_num_joins, max_num_predicates, train_data
...
def get_train_datasets(num_queries, num_materialized_samples):
    dicts, column_min_max_vals, min_val, max_val, labels_train, max_num_joins, max_num_predicates, train_data = load_and_encode_train_data(
    ...
    return dicts, column_min_max_vals, min_val, max_val, labels_train, max_num_joins, max_num_predicates, train_dataset
